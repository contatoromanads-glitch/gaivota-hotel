  ...
  <Layout>
    <section className="relative h-[40vh] min-h-[250px] flex items-center justify-center bg-foreground">
      <div className="relative z-10 text-center px-4">
        ...
        <p className="text-white/85 text-lg">Transparência e segurança para sua hospedagem</p>
      </div>
    </section>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-card rounded-lg border p-6 md:p-8">
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="text-secondary mt-1">•</span>
                A partir de <strong className="text-foreground">6 anos</strong>, cobradas como adultos.
              </li>
              <li className="flex items-start gap-2">
                <span className="text-secondary mt-1">•</span>
                Berço disponível: <strong className="text-foreground">R$ 45/diária</strong> (sujeito a disponibilidade).
              </li>
              <li className="flex items-start gap-2">
                <span className="text-secondary mt-1">•</span>
                Não há camas extras disponíveis.
              </li>
            </ul>
          </div>
          ...
          <div className="bg-card rounded-lg border p-6 md:p-8">
            ...
            <div className="bg-secondary/10 rounded-md p-4 mt-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Empresas que desejam hospedar funcionários podem optar pelo faturamento via <strong className="text-foreground">boleto bancário</strong>. 
